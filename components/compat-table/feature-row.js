 ...
 * @param {import("types/compat.js").SupportStatementExtended|undefined} support - The extended support statement.
 * @param {import("types/bcd.js").BrowserStatement} browser - The browser statement.
 * @returns {import("types/compat.js").SupportClassName}
 */
export function getSupportClassName(support, browser) {
  ...
  /** @type {import("types/compat.js").SupportClassName} */
  let className;
