...
4. Compress the image:
   a. Run pngquant to reduce the colours in the image, try `pngquant --speed 1 twitter-card-summary.png` first, and see if it's indisigunisable from the original
