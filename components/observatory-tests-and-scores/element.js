  ...
  render() {
    return this._fetchMatrixTask.render({
            ...
            <section>
              ...
              <figure class="table-container">
                <table>
                  <thead>
                    <tr>
                      <th>${this.l10n("observatory-tests-and-scores-test-result")`Test result`}</th>
                      <th>${this.l10n("observatory-tests-and-scores-description")`Description`}</th>
                      <th align="center">${this.l10n("observatory-tests-and-scores-modifier")`Modifier`}</th>
                    </tr>
                  </thead>
                  <tbody>
                    ${entry.results.map(
      ...
      error: (error) => html`
        <div class="error">
          ${this
                      .l10n("observatory-tests-and-scores-failed-to-load-tests-and-scoring")`Failed to load tests and scoring data. Please try again later.`}
