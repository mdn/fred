...
compat-support-preview-browser = Unterstützung in Vorschau-Browserversion
...
language-switcher-enable-this-setting-to-always-sw = Aktivieren Sie diese Einstellung, um immer zur aktuellen Sprache zu wechseln, wenn sie verfügbar ist. (Klicken Sie hier, um mehr zu erfahren.)
