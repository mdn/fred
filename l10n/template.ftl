...
compat-no-browsers = No browsers selected. Use "Configure browsers" to choose which browsers to show.
...
compat-settings-open = Customize
compat-settings-title = Customize browser compatibility tables
