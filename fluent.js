...
export class Fluent {
   ...
   * @param {Record<string, import("./fluent-types").Element>} [elements]
...
export default function getFluentContext(locale) {
   ...
   * @returns {import("./fluent-types").L10nTag}
   */
   ...
   * @param {string} [_comment]
   * @returns {import("./fluent-types").L10nTag | string}
   */
  function l10n(idOrStrings, _comment) {
    if (typeof idOrStrings === "string") {
      ...
      /** @type {import("./fluent-types").L10nTag} */
      const tag = (strings) => {
  ...
  /**
   * @param {{ id: string, attr?: string, args?: Record<string, any>, elements?: Record<string, import("./fluent-types").Element> }} param0
   */
  l10n.raw = function ({ id, attr, args, elements }) {
    // TODO: pass actual locale
